...
const _routes = [
  {
    name: "faq",
    path: "/faq",
    component: () => import('./faq-4zyV0CD2.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BzhB0riy.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CTh3XfpI.mjs')
  },
  {
    name: "clients",
    path: "/clients",
    component: () => import('./clients-CFvh7wG0.mjs')
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import('./contacts-CfL_qLkb.mjs')
  },
  {
    name: "licenses",
    path: "/licenses",
    component: () => import('./licenses-DWsnx_E3.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CysZFkRU.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BNIOkQUb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BxAsm26Z.mjs'));
